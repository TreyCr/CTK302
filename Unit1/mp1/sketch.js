//time log
  //Built the Scene: (1am-2am),(2:42am-2:55am) - 1 hour and 13 minutes
  //Design Character: (2am-2:30am) - 30 minutes
  //Backstory: (2:30am-2:42am) - 12 minutes
...
function draw() {
  ...
  if (mouseIsPressed) {
    ...
    textSize(15);
    fill(0);
    //got the let s idea/code from Henry's example on Reggienet
